...
public class ImageUtil {
	...
	public static void main(String[] args) throws IOException {
		//输入文件
		Thumbnails.of(new File("D:/JAVA_places/schoolShop/picture/hollowknight.jpg")).size(200, 200)
				.watermark(Positions.BOTTOM_RIGHT, ImageIO.read(new File(basePath + "/watermark.jpg")), 0.25f)
				//输出文件
				.outputQuality(0.8f).toFile("D:/JAVA_places/schoolShop/picture/hollowknightnew.jpg");
	}
